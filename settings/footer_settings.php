...
// footer branding
$name = 'theme_stardust/brandorganization';
...
// footer branding
$name = 'theme_stardust/brandwebsite';
...
// footer branding
$name = 'theme_stardust/brandphone';
...
// footer branding
$name = 'theme_stardust/brandemail';
...
$name = 'theme_stardust/socialiconsinfo';
...
// Google+ url setting.
$name = 'theme_stardust/googleplus';
...
$name = 'theme_stardust/socialicon1';
...
$name = 'theme_stardust/socialicon2';
$title = get_string('sociallinkicon', 'theme_fordson');
$description = get_string('sociallinkicondesc', 'theme_fordson');
$default = 'home';
$setting = new admin_setting_configtext($name, $title, $description, $default);
...
$name = 'theme_stardust/socialicon3';
$title = get_string('sociallinkicon', 'theme_fordson');
$description = get_string('sociallinkicondesc', 'theme_fordson');
$default = 'home';
$setting = new admin_setting_configtext($name, $title, $description, $default);
