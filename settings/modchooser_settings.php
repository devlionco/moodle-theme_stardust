...
// Custom Menu label
$name = 'theme_stardust/modchoosercustomlabel';
...
$setting = new admin_setting_configtextarea('theme_stardust/commonlyused', get_string('commonlyused', 'theme_fordson'), get_string('commonlyuseddesc', 'theme_fordson'), '', PARAM_RAW);
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

// show only custom activities/resource
$name = 'theme_stardust/showonlycustomactivities';
...
// show only custom activities/resource
$name = 'theme_stardust/showalltomanager';
