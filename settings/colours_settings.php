...
$page->add(new admin_setting_heading('theme_fordson_colours', get_string('colours_headingsub', 'theme_fordson'), format_text(get_string('colours_desc' , 'theme_fordson'), FORMAT_MARKDOWN)));
    ...
    $name = 'theme_stardust/brandsuccess';
    ...
    $name = 'theme_stardust/brandwarning';
    ...
    $name = 'theme_stardust/branddanger';
    ...
    $name = 'theme_stardust/bodybackground';
    ...
    $name = 'theme_stardust/topnavbarbg';
    ...
    // Top navbar background setting.
    $name = 'theme_stardust/topnavbarteacherbg';
    ...
    $name = 'theme_stardust/breadcrumbbkg';
    ...
    $name = 'theme_stardust/markettextbg';
    ...
    $setting = new admin_setting_configtextarea('theme_stardust/scss', get_string('rawscss', 'theme_fordson'),
