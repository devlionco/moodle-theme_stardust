...
/**
 * Strings for component 'theme_stardust', language 'en'
 *
...
$string['configtitle'] = 'Stardust';
$string['pluginname'] = 'Stardust';
...
$string['forgot_password'] = 'Oops, I forgot my password';
$string['enter'] = 'Enter';
...
$string['pluginname'] = 'Stardust';
$string['privacy:metadata'] = 'The stardust theme does not store any personal data about any user.';
...
//page my
$string['page_greeting'] = 'Good come back!';
$string['what_doing_today'] = 'What am I doing today?';
$string['what_doing_week'] = 'What am I doing this week?';
$string['what_doing_month'] = 'What am I doing this month?';
$string['type'] = 'Type';
$string['name'] = 'Name';
$string['course'] = 'Course';
$string['date_of_submission'] = 'Date of submission';
$string['name_of_assignment'] = 'Name of assignment';
$string['name_of_unit'] = 'Name of unit';
$string['name_of_course'] = 'Name of course';
$string['messages'] = 'Messages';
$string['notifications'] = 'Notifications';
$string['grades'] = 'Grades';
$string['medal'] = 'Medal';
$string['diplom'] = 'Diplom';
...
$string['dayname_1'] = 'Monday';
$string['dayname_2'] = 'Tuesday';
$string['dayname_3'] = 'Wednesday';
$string['dayname_4'] = 'Thursday';
...
$string['sort_assignname'] = 'Sort by assignment name';
$string['sort_coursename'] = 'Sort by course name';
$string['sort_cutofdate'] = 'Sort by submission date';

$string['active_courses'] = 'Active courses';
$string['courses_finished'] = 'Courses I finished';
$string['by_date'] = 'By date';
$string['by_abc'] = 'By ABC';
$string['default_unit_name'] = 'Unit ';
$string['submission_of_assignment'] = 'Submission of assignment';
$string['actionwithtask'] = 'Start of activity';
$string['turntotheteacher'] = 'Contacting the teacher';

// Theme settings -- My dashboard page
$string['mydashboardsettigs'] = 'My dashboard page';
$string['mydashboardsettigs_desc'] = 'Settings for dashboard page';
$string['mydashboardbgimage'] = 'Background image';
...
$string['display_messages'] = 'Display messages';
$string['display_messages_desc'] = 'Show or hide block';
$string['display_grades'] = 'Display grades';
$string['display_grades_desc'] = 'Show or hide block';



// profile page
$string['profile_greeting'] = 'Hi! This is your profile page';
$string['profile_picture'] = 'Profile picture';
$string['change_picture'] = 'Change picture';
...
// course page
$string['gohome'] = 'Home ›';
$string['study_units'] = 'Study units';
